...
An internal AI video script generation platform where the team captures story briefs, structures them into polished scripts, and tracks generation usage end-to-end.
